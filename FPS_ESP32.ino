...
const unsigned long myChannelNumber = 2780207;
const char* myWriteAPIKey = "XC92PFC1WVEY8LME";
unsigned long myTalkBackID = 54103;
const char* myTalkBackKey = "LKZMBMGVL7AK4LU5";
...
void checkAlert() {
  HTTPClient http;
  String url = "https://api.thingspeak.com/channels/2833936/fields/1.json?api_key=99S24B0A3T1KYIVN";
